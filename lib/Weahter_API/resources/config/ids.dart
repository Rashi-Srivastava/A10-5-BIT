class Ids {
  ...
  static final String rainPage = "rain_page";
  static final String pressurePage = "pressure_page";
  static final String storageLocationKey = "feather_location";
  static final String storageWeatherKey = "feather_weather";
