...
class _Sell_nowState extends State<Sell_now> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text("Sell your item here")
      ),
              ...
              Column(
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Quantity in Kgs",            //Maximum number of participants
                      labelStyle: TextStyle(
                          fontSize: 14,
                          color: Colors.grey.shade400,
                          fontWeight: FontWeight.w600),
                  ...
                  Container(
                    ...
                    child: FlatButton(
                      onPressed: () async{
                        ...
                        var res=await Sell(_base64,name,amount,desp,quantity);
                        if(res==200)
                          {
                            Navigator.push(
                              context,
