...
class tool_screen extends StatefulWidget with DrawerStates{
  @override
  _tool_screenState createState() => _tool_screenState();
}

class _tool_screenState extends State<tool_screen> {
  Razorpay razorpay;
                                                    ...
                                                    RichText(
                                                      text: TextSpan(
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                              text:
                                                              snapshot.data['Data'][index]['Tools Name'],
                                                              style: TextStyle(color: Colors.green,fontSize: 15,fontWeight: FontWeight.w800)),
                                                        ],
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            GestureDetector(
                                                              onTap:(){
                                                                openCheckout(int.parse(snapshot.data['Data'][index]['Cost']),snapshot.data['Data'][index]['Tools Name']);
                                                              },
                                                              child: Container(
                                                                height:
                                                                40,
