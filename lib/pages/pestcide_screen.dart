...
class pesticide_screen extends StatefulWidget with DrawerStates{
  @override
  _pesticide_screenState createState() => _pesticide_screenState();
}

class _pesticide_screenState extends State<pesticide_screen> {
  Razorpay razorpay;
                                                    ...
                                                    RichText(
                                                      text: TextSpan(
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                              text:
                                                              snapshot.data['Data'][index]['Pestiside Name'],
