...
class fertilizer_screen extends StatefulWidget with DrawerStates{
  @override
  _fertilizer_screenState createState() => _fertilizer_screenState();
}

class _fertilizer_screenState extends State<fertilizer_screen> {
  Razorpay razorpay;
                                                    ...
                                                    RichText(
                                                      text: TextSpan(
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                              text:
                                                              snapshot.data['Data'][index]['Fertilizer Name'],
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            GestureDetector(
                                                              onTap:(){
                                                                openCheckout(int.parse(snapshot.data['Data'][index]['Cost']),snapshot.data['Data'][index]['Fertilizer Name']);
                                                              },
                                                              child: Container(
                                                                height:
                                                                40,
